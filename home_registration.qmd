...
::: {.callout-warning}
This workshop is not intended for beginners or those new to R. If you have little or no experience using R, we recommend starting with an introductory course first.
:::
...
::: {.callout-note}
Early bird registrants will receive information about special hotel deals.
:::
...
tibble::tribble(
  ...
  "<strong>01-Jan-2026 00:00</strong>", "Early bird rate ends",
