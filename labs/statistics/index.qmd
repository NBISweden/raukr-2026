...
Let us use the advertising data set, to see if we can learn something about the relationship between TV advertising and sales. In other words, we are estimating the beta coefficients in the following equation: $sales = \beta_0 + \beta_1TV + \epsilon$. We are going to assume that we are statistical consultants that were hired by a client to investigate the association between advertising and the sales, in thousands of unites, of a particular product. The data contains advertising budgets for the product for three different media: TV, radio and newspaper. Can we learn something about the relationship between sales and advertising that can guide or inform future marketing plans?
