...
- **S3** -- basic R OOP system inherited from the S language, 
- **S4** -- a bit more advanced OOP, common in, e.g. Bioconductor,
- **RC** -- Reference Classes, closer to, e.g. Java OOP, extension of S4, modify-in-place,
- **R6** -- simplified RC, extension of S3, `require(R6)`
- **S7** -- best of S3 + S4 = S7 `require(S7)`. Relatively new.

. . .

![https://xkcd.com/927/](assets/standards_xkcd.png){height="400px"}

## S4 classes

In S4 classes you define the structure of the data within the object of your particular class:
